package com.example.duanmauky4.Database;
...
import com.example.duanmauky4.Model.TheLoai;
...
public class TheLoaiDAO {
    ...
    public static final String SQL_THE_LOAI ="CREATE TABLE TheLoai (matheloai text " +
            "primary key, tentheloai text, mota text, vitri int);";
